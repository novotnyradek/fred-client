...
import fred.client.data.common.contact.IdentType;
...
import fred.client.data.info.contact.ContactStatusValueType;
...
import fred.client.data.info.keyset.KeysetStatusValueType;
import fred.client.data.info.nsset.NssetInfoResponse;
import fred.client.data.info.nsset.NssetStatusValueType;
import fred.client.data.poll.PollResponse;
import fred.client.data.poll.contact.ContactDeletionPollResponse;
import fred.client.data.poll.contact.ContactTransferPollResponse;
import fred.client.data.poll.contact.ContactUpdatePollResponse;
import fred.client.data.poll.domain.DomainTransferPollResponse;
import fred.client.data.poll.domain.DomainUpdatePollResponse;
import fred.client.data.poll.keyset.KeysetDeletionPollResponse;
import fred.client.data.poll.keyset.KeysetTransferPollResponse;
import fred.client.data.poll.keyset.KeysetUpdatePollResponse;
import fred.client.data.poll.nsset.NssetDeletionPollResponse;
import fred.client.data.poll.nsset.NssetTransferPollResponse;
import fred.client.data.poll.nsset.NssetUpdatePollResponse;
import fred.client.data.poll.nsset.TechnicalCheckResultsPollResponse;
...
import fred.client.data.update.contact.ContactChangeData;
import fred.client.data.update.contact.ContactUpdateRequest;
import fred.client.data.update.domain.DomainAddData;
import fred.client.data.update.domain.DomainChangeData;
import fred.client.data.update.domain.DomainUpdateRequest;
import fred.client.data.update.keyset.KeysetAddData;
