 ...
 * <p>
 * <ul>
 * <li>{@link ContactTransferPollResponse#id} - an object handle</li>
 * <li>{@link ContactTransferPollResponse#trDate} - the date of the transfer</li>
 * <li>{@link ContactTransferPollResponse#clID} - the handle of the registrar who requested the transfer</li>
 * </ul>
 * </p>
 *
 ...
 */
public class ContactTransferPollResponse extends PollResponse implements Serializable {
    ...
    public ContactTransferPollResponse() {
        setPollMessageType(PollMessageType.CONTACT_TRANSFER);
    }
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("ContactTransferPollResponse{");
