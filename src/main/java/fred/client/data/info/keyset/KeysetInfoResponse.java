 ...
 * <p>
 * <ul>
 * <li>{@link KeysetInfoResponse#id} – a keyset handle as fredcom:objIDType</li>
 * <li>{@link KeysetInfoResponse#roid} – the keyset repository identifier as eppcom:roidType</li>
 * <li>{@link KeysetInfoResponse#status} – the state name, see {@link KeysetStatusValueType}</li>
 * <li>{@link KeysetInfoResponse#clID} – the designated registrar’s handle as eppcom:clIDType</li>
 * <li>{@link KeysetInfoResponse#crID} – the handle of the registrar who created this keyset as eppcom:clIDType</li>
 * <li>{@link KeysetInfoResponse#crDate} – the timestamp of creation as xs:dateTime</li>
 * <li>{@link KeysetInfoResponse#upID} – the handle of the registrar who was the last to update this keyset as eppcom:clIDType</li>
 * <li>{@link KeysetInfoResponse#upDate} – the timestamp of the last update as xs:dateTime</li>
 * <li>{@link KeysetInfoResponse#trDate} – the timestamp of the last transfer as xs:dateTime</li>
 * <li>{@link KeysetInfoResponse#authInfo} – authorization information (transfer password) as fredcom:authInfoType</li>
 * <li>{@link KeysetInfoResponse#dnskey} – a DNS key</li>
 * <li>{@link KeysetInfoResponse#id} – a technical contact handle as fredcom:objIDType</li>
 *</ul>
 *
